# Generated by Django 5.0.4 on 2024-05-23 14:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('active', models.BooleanField(default=True)),
                ('notification', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='theses.notification')),
        ...
        migrations.AddField(
            model_name='user',
            name='notifications',
            field=models.ManyToManyField(blank=True, null=True, through='theses.NotificationUser', to='theses.notification'),
        ),
        migrations.CreateModel(
            name='CouncilDetail',
            fields=[
        ...
        migrations.AddField(
            model_name='council',
            name='schoolyear',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='theses.schoolyear'),
        ),
        migrations.CreateModel(
            name='ScoreColumn',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scoreColumns', models.ManyToManyField(blank=True, null=True, through='theses.ScoreDetail', to='theses.scorecolumn')),
        ...
        migrations.AddField(
            ...
            name='thesis_score',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='theses.thesisscore'),
        ),
        migrations.AddField(
            model_name='councildetail',
            name='theses',
            field=models.ManyToManyField(blank=True, null=True, through='theses.ThesisScore', to='theses.thesis'),
        ),
        migrations.AddField(
            model_name='thesis',
            name='lecturers',
            field=models.ManyToManyField(blank=True, null=True, through='theses.Supervisor', to='theses.lecturer'),
        ),
        migrations.AddField(
            model_name='councildetail',
            name='lecturer',
        ...
        migrations.AddField(
            model_name='council',
            name='lecturers',
            field=models.ManyToManyField(blank=True, null=True, through='theses.CouncilDetail', to='theses.lecturer'),
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
